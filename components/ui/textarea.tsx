...
import { cn } from "@/utils/cn"; // Check if this import is correct
...
const TextArea = React.forwardRef<HTMLTextAreaElement, InputProps>(
  ({ className, ...props }, ref) => {
    ...
    return (
      ...
      >
        <textarea
          rows={props.rows ?? 3} // Make rows dynamic, default to 3
          cols={props.cols ?? 50} // Make cols dynamic, default to 50
          className={cn(
